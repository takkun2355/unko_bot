...
class Fun(commands.Cog):
    ...
    async def randname(self, ctx):
        """ランダム名前ジェネレーター"""
        prefixes = ["スーパー", "激辛", "最強", "謎の", "爆裂", "臭い", "最恐", "伝説", "ド変態", "go to hell"]
        bases = ["犬", "ネコ", "ドラゴン", "忍者", "unkoman", "aga", "akikueko", "らむ", "永藤 英機", "MilkT"]
        suffixes = ["マスター", "キング", "丸", "先輩", "ちゃん", "ロール", "きゃん", "ちょんちょんﾊﾟｰ", "くん", "しね！！", "育♡"]
