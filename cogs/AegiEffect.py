...
# 文字重ねマッピング
KANA_TO_DOUBLE = {
    "あ": "ああ", "い": "いい", "う": "うう", "え": "ええ", "お": "おお",
    "か": "かか", "き": "きき", "く": "くく", "け": "けけ", "こ": "ここ",
    "さ": "ささ", "し": "しし", "す": "すす", "せ": "せせ", "そ": "そそ",
    "た": "たた", "ち": "ちち", "つ": "つつ", "て": "てて", "と": "とと",
    "な": "なな", "に": "にに", "ぬ": "ぬぬ", "ね": "ねね", "の": "のの",
    "は": "はは", "ひ": "ひひ", "ふ": "ふふ", "へ": "へへ", "ほ": "ほほ",
    "ま": "まま", "み": "みみ", "む": "むむ", "め": "めめ", "も": "もも",
    "や": "やや", "ゆ": "ゆゆ", "よ": "よよ",
    "ら": "らら", "り": "りり", "る": "るる", "れ": "れれ", "ろ": "ろろ",
    "わ": "わわ", "を": "をを", "ん": "んん",
    "が": "がが", "ぎ": "ぎぎ", "ぐ": "ぐぐ", "げ": "げげ", "ご": "ごご",
    "ざ": "ざざ", "じ": "じじ", "ず": "ずず", "ぜ": "ぜぜ", "ぞ": "ぞぞ",
    "だ": "だだ", "ぢ": "ぢぢ", "づ": "づづ", "で": "でで", "ど": "どど",
    "ば": "ばば", "び": "びび", "ぶ": "ぶぶ", "べ": "べべ", "ぼ": "ぼぼ",
    "ぱ": "ぱぱ", "ぴ": "ぴぴ", "ぷ": "ぷぷ", "ぺ": "ぺぺ", "ぽ": "ぽぽ",
    "ぁ": "ぁぁ", "ぃ": "ぃぃ", "ぅ": "ぅぅ", "ぇ": "ぇぇ", "ぉ": "ぉぉ",
    "ゃ": "ゃゃ", "ゅ": "ゅゅ", "ょ": "ょょ", "っ": "っっ", "ッ": "ッッ",
    "ゕ": "ゕゕ", "ㇰ": "ㇰㇰ", "ヶ": "ヶヶ", "ゎ": "ゎゎ",
    "ー": "ーー", "…": "……", "、": "、、", "！": "！！", "♥": "♥♥",
}
...
async def get_aegi_random_text(bot: commands.Bot, guild_id: int) -> str | None:
    ...
    try:
        from cogs.AegiGenerator import GeneratorEngine
